...
const HomePage = () => {
  ...
  <h1 className="text-8xl font-bold mb-5">Your Rental Solution Simplified! 🏘️</h1>
  <p className="text-3xl italic leading-relaxed">
    Streamline your property rental with ease and connect with the right tenants today.
  </p>
